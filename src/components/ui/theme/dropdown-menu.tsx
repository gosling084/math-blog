// src/components/ui/theme/dropdown-menu.tsx
"use client"
...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      inset && styles.dropdownMenuSubTriggerInset,
      className
    )}
    {...props}
  >
    {children}
    <ChevronRight className={styles.dropdownMenuSubTriggerRight} />
  </DropdownMenuPrimitive.SubTrigger>
))
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      inset && styles.dropdownMenuItemInset,
      className
    )}
    {...props}
  />
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ...
    className={cn(
      ...
      inset && styles.dropdownMenuLabelInset,
      className
    )}
    {...props}
  />
